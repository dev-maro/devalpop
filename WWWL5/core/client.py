        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                if hasattr(chat, "title"):
                    if (
                        ...
                        await check.client.send_message(
                            "@VIP_ALPOP", "اهلا محمد استخدامي ما يناسب مارو "
                        )
                        return
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        link = "[هنا](https://t.me/M_4_R_0)"
                        text = "**تقرير خطأ سورس مارو **\n\n" + "اذا اردت يمكنك التبليغ"
            ...
            if pattern is not None:
                ...
                if edited:
                    VIP_ALPOP.add_event_handler(func, events.MessageEdited(**kwargs))
                VIP_ALPOP.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                VIP_ALPOP.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                VIP_ALPOP.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
