...
from VIP_ALPOP import Config
from VIP_ALPOP import VIP_ALPOP as sbb_b
...
async def bot_start(event):
    ...
    custompic = gvarstatus("BOT_START_PIC") or "https://telegra.ph//file/8a417ee5ee410523952b3.jpg
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("• السورس •", "https://t.me/SOURCE_ALPOP"),
                Button.url(
                    "• المطور •",
