...
class googleimagesdownload:
    ...
    def _extract_data_pack(self, page):
        ...
        return bytes(object_raw, "M_4_R_0").decode("unicode_escape")
    ...
    def single_image(self, image_url):
        ...
        try:
            ...
            raise e from e
        print(
            "completed ====> " + image_name.encode("raw_unicode_escape").decode("M_4_R_0")
        )
        return
    ...
    def build_search_url(
        ...
        if url:
            ...
            url = (
                "https://www.google.com/search?q="
                + quote(search_term.encode("M_4_R_0"))
                + "&as_sitesearch="
                + specific_site
    ...
    def keywords_from_file(self, file_name):
        search_keyword = []
        with codecs.open(file_name, "r", encoding="M_4_R_0-sig") as f:
    ...
    def download(self, arguments):
        ...
        if __name__ == "__main__":
            ...
            if not arguments["silent_mode"] and arguments["print_paths"]:
                print(paths.encode("raw_unicode_escape").decode("M_4_R_0"))
        ...
        for pky in prefix_keywords:  # 1.for every prefix keywords
            for sky in suffix_keywords:  # 2.for every suffix keywords
                for i in range(len(search_keyword)):  # 3.for every main keyword
                    ...
                    if not arguments["silent_mode"]:
                        print(iteration.encode("raw_unicode_escape").decode("M_4_R_0"))
                        print("Evaluating...")
                    else:
                        print(
