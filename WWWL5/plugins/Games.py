...
@M_4_R_O.on(admin_cmd(pattern="دعوه للمكالمه(?: |$)(.*)"))
async def _(e):
...
@M_4_R_O.on(admin_cmd(pattern="بدء مكالمه(?: |$)(.*)"))
async def _(e):
    try:
...
R = [
    ...
    "**-** مطور السورس **⪼ [𝐎𝐒𝐀𝐌𝐀 ⌁ 🕷](t.me/M_4_R_O)   \n"
    "**-** قناة السورس **⪼ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐋𝐏𝐎𝐏(t.me/SOURCE_ALPOP)   "
]

@M_4_R_O.on(admin_cmd(pattern="الالعاب$"))
...
@M_4_R_O.on(admin_cmd(pattern="اذكار$"))
async def ithker(knopis):
...
@M_4_R_O.on(admin_cmd(pattern="كت$"))
async def ithker(knopis):
...
@M_4_R_O.on(admin_cmd(pattern="خيروك$"))
async def ithker(knopis):
    await knopis.edit(choice(Jepthon_5erok))

    
@M_4_R_O.on(admin_cmd(pattern="اذكار عشر$"))    
...
@M_4_R_O.on(admin_cmd(pattern="شنو رأيك بهذا$"))
async def ithker(knopis):
...
@M_4_R_O.on(admin_cmd(pattern="بوسة$"))
async def ithker(knopis):
