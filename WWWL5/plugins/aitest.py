...
from VIP_ALPOP import VIP_ALPOP 
...
# code by t.me/VIP_ALPOP
@VIP_ALPOP.ar_cmd(pattern="os(?:\s|$)([\s\S]*)")
async def song2(event):
    song = event.pattern_match.group(1)
    chat = "@OpenAI_GPT_Chatbot" # code by t.me/VIP_ALPOP
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await VIP_ALPOP(unblock("OpenAI_GPT_Chatbot"))
            gool = "{}".format(song)
            await conv.send_message(gool)
