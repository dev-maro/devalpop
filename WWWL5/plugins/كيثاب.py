...
@M_4_R_O.ar_cmd(
    ...
    info={
        "header": "Source code link of M_4_R_O",
        "usage": [
            "{tr}repo",
        ],
    },
...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "اضغط [هنا](t.me/M_4_R_0) لفتح قناة السورس\
        \nاضغط [هنا](t.me/MA_99O) جروب الدعم",
    )
...
@M_4_R_O.ar_cmd(
    ...
    info={
        ...
        "description": "It uploads the given file to your github repo in **M_4_R_O/plugins** folder\
...
async def git_commit(file_name, mone):
    ...
    file = open(file_name, "r", encoding="M_4_R_0")
    ...
    if create_file:
        file_name = f"M_4_R_O/plugins/{file_name}"
        LOGS.info(file_name)
        try:
            repo.create_file(
            ...
            ccess = ccess.strip()
            await mone.edit(
                f"`Commited On Your Github Repo`\n\n[Your PLUGINS](https://github.com/{ccess}/tree/master/M_4_R_O/plugins/)"
            )
